...
using MediaPoint.Controls.Effects;
...
namespace MediaPoint.Controls
{
    ...
    public abstract class D3DRenderer : FrameworkElement
    {
        ...
        public event EventHandler NaturalSizeChanged;
        ...
        /// </summary>
        protected IntPtr m_pBackBuffer = IntPtr.Zero;
        ...
        /// </summary>
        protected void SetBackBufferInternal(IntPtr backBuffer)
        {
        ...
        {
            bool changed = NaturalVideoHeight != m_d3dImage.PixelHeight || NaturalVideoWidth != m_d3dImage.PixelWidth;
