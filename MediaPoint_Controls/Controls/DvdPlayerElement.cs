...
namespace MediaPoint.Controls
{
    public class DvdPlayerElement : MediaSeekingElement
    {
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
			...
			System.Diagnostics.Debug.WriteLine(widthMultiplier + " " + heightMultiplier);
            DvdPlayer.Dispatcher.BeginInvoke((Action)(() => DvdPlayer.SelectAtPosition(widthMultiplier, heightMultiplier)));
			//DvdPlayer.Dispatcher.BeginInvoke((Action)(() => DvdPlayer.SelectAtPosition(position.X, position.Y)));
			base.OnMouseMove(e);
        }
