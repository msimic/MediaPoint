...
namespace MediaPoint.Controls
{
    ...
    public abstract class MediaSeekingElement : MediaElementBase
    {
        ...
        public void SetMediaPositionInternal(long value)
        {
		...
		public static readonly DependencyProperty MediaDurationProperty
			= DependencyProperty.Register("MediaDuration", typeof(long), typeof(MediaSeekingElement), new UIPropertyMetadata((long)0));
        ...
        public long MediaDuration
        {
			...
			set
			{
				SetValue(MediaDurationProperty, value);
			}
        }
