...
namespace MediaPoint.Subtitles.Logic
{
    ...
    public class Settings
    {
        ...
        private static Settings CustomDeserialize(string fileName)
        {
            ...
            settings.RecentFiles = new MediaPoint.Subtitles.Logic.RecentFilesSettings();
            ...
            settings.General = new MediaPoint.Subtitles.Logic.GeneralSettings();
            ...
            settings.Tools = new MediaPoint.Subtitles.Logic.ToolsSettings();
            ...
            settings.SubtitleSettings = new MediaPoint.Subtitles.Logic.SubtitleSettings();
            ...
            settings.Proxy = new MediaPoint.Subtitles.Logic.ProxySettings();
            ...
            settings.WordLists = new MediaPoint.Subtitles.Logic.WordListSettings();
            ...
            settings.CommonErrors = new MediaPoint.Subtitles.Logic.FixCommonErrorsSettings();
            ...
            settings.VobSubOcr = new MediaPoint.Subtitles.Logic.VobSubOcrSettings();
