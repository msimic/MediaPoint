...
namespace MediaPoint.Subtitles.Logic
{
    public class Paragraph
    {
		...
		public VobSub.VobSubMergedPack VobSubMergedPack { get; set; }
		public Bitmap GetImage()
		{
			return VobSubMergedPack.SubPicture.GetBitmap(null, Color.Transparent, Color.White, Color.Black, Color.Black, true);
		}
