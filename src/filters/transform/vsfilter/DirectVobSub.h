...
class CDirectVobSub : public IDirectVobSub2, public IDirectVobSubXy, public IFilterVersion, public IDirectVobSub3
{
public:
...
public:
	...
	STDMETHODIMP OpenSubtitle(WCHAR* fn) { return E_NOTIMPL; };
	STDMETHODIMP SkipAutoloadCheck(int val) { return E_NOTIMPL; };
    ...
    STDMETHODIMP get_TextSettings(LOGFONTW* lf, int lflen, COLORREF* color, bool* fShadow, bool* fOutline, bool* fAdvancedRenderer);
    STDMETHODIMP put_TextSettings(LOGFONTW* lf, int lflen, COLORREF color, bool fShadow, bool fOutline, bool fAdvancedRenderer);
