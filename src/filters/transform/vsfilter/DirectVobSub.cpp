...
STDMETHODIMP CDirectVobSub::get_TextSettings(LOGFONTW* lf, int lflen, COLORREF* color, bool* fShadow, bool* fOutline, bool* fAdvancedRenderer)
{
	CAutoLock cAutoLock(&m_propsLock);
...
STDMETHODIMP CDirectVobSub::put_TextSettings(LOGFONT* lf, int lflen, COLORREF color, bool fShadow, bool fOutline, bool fAdvancedRenderer)
{
	CAutoLock cAutoLock(&m_propsLock);
...
/*STDMETHODIMP CDirectVobSub::OpenSubtitle(WCHAR* fn) {
	return -1;
}*/
